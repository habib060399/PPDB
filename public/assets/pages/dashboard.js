...
!(function ($) {
    ...
    //creates plot graph
    (Dashboard.prototype.createPlotGraph = function (
        selector,
        data1,
        data2,
        labels,
        ...
        $.plot(
            $(selector),
            [{ data: data1, label: labels[0], color: colors[0] }],
            {
                series: {
                    lines: {
                        show: true,
        ...
        (Dashboard.prototype.createCombineGraph = function (
            selector,
            ticks,
            labels,
            datas
        ...
        //creates Pie Chart
        (Dashboard.prototype.createPieGraph = function (
            selector,
            labels,
            datas,
            colors
